...
public class OAuth2Controller {
    ...
    private User findOrCreateUser(Map<String, Object> googleUserInfo) { 
        ...
        if (googleUserInfo.get("given_name") != null) {
            userDTO.setFirstName(String.valueOf(googleUserInfo.get("given_name")));
        }
        if (googleUserInfo.get("family_name") != null) {
            userDTO.setLastName(String.valueOf(googleUserInfo.get("family_name")));
        }
